...
# Replace with your chosen gateway's keys
...
RAZORPAY_KEY_ID = os.environ.get('RAZORPAY_KEY_ID', 'rzp_test_YOUR_RAZORPAY_KEY_ID')
RAZORPAY_KEY_SECRET = os.environ.get('RAZORPAY_KEY_SECRET', 'YOUR_RAZORPAY_KEY_SECRET')

# Add your app to INSTALLED_APPS if it's not already there
INSTALLED_APPS = [
    # ...
    'application', # Assuming your app is named 'application'
    # ...
]
